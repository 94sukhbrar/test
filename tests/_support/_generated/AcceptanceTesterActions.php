...
// [STAMP] 809131d7e26dfc4cbbea0077d23c3eeb
...
trait AcceptanceTesterActions
{
	 ...
	 * ```
	 *
	 * @param $raw Conditional
	 *        	Assertion: Test won't be stopped on fail
	 ...
	 *
	 * @param string|null $name
	 * @see \Codeception\Module\WebDriver::switchToIFrame() public function switchToIFrame($name = null) {
	 ...
	 *        	css or xpath of the web element
	 * @param int $offsetX
	 * @param int $offsetY
	 *
	 * @throws \Codeception\Exception\ElementNotFound
	 ...
	 *        	$element
	 * @param $char Can
	 *        	be char or array with modifier. You can provide several chars.
	 * @throws \Codeception\Exception\ElementNotFound
	 ...
	 * @param string $value
	 *        	the value to set it to for subsequent
	 *        	requests
